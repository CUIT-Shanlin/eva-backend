...
public class EvaQueryGatewayImpl implements EvaQueryGateway {
    ...
    public List<EvaTaskEntity> evaSelfTaskInfo(Integer id, String keyword){
        ...
        if(teacherWrapper!=null||subjectWrapper!=null){
            ...
            List<EvaTaskEntity> list=getEvaTaskEntities(evaTaskDOS,userEntities,courseEntities);
    ...
    public List<EvaRecordEntity> getEvaLogInfo(Integer id,String keyword) {
        ...
        if(teacherWrapper!=null||subjectWrapper!=null){
            ...
            List<EvaRecordEntity> list=getRecordEntities(formRecordDOS,evaTaskEntityList);
            return list;
        }else{
...
//ok
    ...
    public Optional<String> getTaskTemplate(Integer taskId, Integer semId) {
        ...
        if(courOneEvaTemplateDO==null){
            s=courOneEvaTemplateDO.getFormTemplate();
        }else {
            s=formTemplateDO.getProps();
        }
    ...
    public List<ScoreRangeCourseCO> scoreRangeCourseInfo(Integer num, Integer interval) {
        ...
        List<ScoreRangeCourseCO> scoreRangeCourseCOS = null;
    ...
    private Double stringToSumAver(String s) {
        ...
        Double averScore=score/jsonObject.size();
        return averScore;
    }
