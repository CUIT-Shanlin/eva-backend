...
7) ✅ **系统管理读侧渐进收敛**：`UserQueryGatewayImpl.findIdByUsername/findUsernameById/getUserStatus/isUsernameExist` 已收敛到 `bc-iam`（含缓存读写与 Optional 语义，保持行为不变；落地提交：`9f664229/38384628/de662d1c/8a74faf5`）。
