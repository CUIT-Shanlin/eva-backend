...
public class BcCourseConfiguration {
    ...
    @Bean
    public UpdateSingleCourseGatewayEntryUseCase updateSingleCourseGatewayEntryUseCase(UpdateSingleCourseUseCase useCase) {
        return new UpdateSingleCourseGatewayEntryUseCase(useCase);
    }
    ...
    @Bean
    public UpdateSelfCourseGatewayEntryUseCase updateSelfCourseGatewayEntryUseCase(UpdateSelfCourseUseCase useCase) {
        return new UpdateSelfCourseGatewayEntryUseCase(useCase);
    }
    ...
    @Bean
    public AddNotExistCoursesDetailsGatewayEntryUseCase addNotExistCoursesDetailsGatewayEntryUseCase(AddNotExistCoursesDetailsUseCase useCase) {
        return new AddNotExistCoursesDetailsGatewayEntryUseCase(useCase);
    }
