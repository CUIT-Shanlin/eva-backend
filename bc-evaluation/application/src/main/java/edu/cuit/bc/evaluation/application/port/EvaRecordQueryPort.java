 ...
 * 评教记录读侧查询端口。
 */
public interface EvaRecordQueryPort extends EvaRecordScoreQueryPort, EvaRecordPagingQueryPort, EvaRecordUserLogQueryPort, EvaRecordCourseQueryPort, EvaRecordCountQueryPort {
