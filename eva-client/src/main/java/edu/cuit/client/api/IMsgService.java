...
public interface IMsgService {
     ...
     */
    List<WebsocketResponseMsg> getUserTargetTypeMsg(Integer type, Integer mode);
     ...
     * @param type 消息类型（0：待办，1：通知，2：提醒，3：警告；null或者负数：全部）
     */
    List<WebsocketResponseMsg> getUserTargetAmountAndTypeMsg(Integer num, Integer type);
     ...
     * @param msg 消息对象
     */
    void sendMessage(WebsocketRequestMsg msg);
