...
public class CreateUserUseCase {
    private final UserCreationPort creationPort;

    public CreateUserUseCase(UserCreationPort creationPort) {
        this.creationPort = creationPort;
    }

    public void execute(NewUserCmd cmd) {
        creationPort.createUser(cmd);
    }
}
