...
2) 读侧：`EvaQueryRepository` 仍为大聚合查询实现，需继续拆分（保持口径/异常文案不变；接口已完成统计/记录/任务/模板四主题拆分：`d5b07247/cae1a15c/82427967/889ec9b0`；实现侧已完成统计/记录/任务主题拆分：`9e0a8d28/985f7802/d467c65e`）
