...
class EvaStatisticsQueryUseCaseTest {
    ...
    @Test
    void getTargetAmountUnqualifiedUserOrEmpty_type0_whenEmpty_shouldReturnZeroResult() {
        EvaStatisticsQueryUseCase useCase = new EvaStatisticsQueryUseCase(
                overviewQueryPort,
                trendQueryPort,
                unqualifiedUserQueryPort,
        ...
        UnqualifiedUserResultCO result = useCase.getTargetAmountUnqualifiedUserOrEmpty(1, 0, 7);
